...
#PBS -q prod
#PBS -A UIC-HPC
#PBS -o ddp_train_polaris_32gpu_4b_16b.%j.out
#PBS -e ddp_train_polaris_32gpu_4b_16b.%j.err
#PBS -N ddp-train_polaris_32gpu_4b_16b
...
BATCH_SIZES=(
    "4"
    #"8"        # strong global 128 on 16 GPUs
