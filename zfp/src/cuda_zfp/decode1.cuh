                     ...
                     cudaStream_t cuda_stream)
{
  ...
  cudaDecode1<Scalar> <<<grid_size, block_size, 0, cuda_stream>>>
    (stream,
     d_data,
     dim,
     stride,
...
size_t decode1(int dim, 
               ...
               cudaStream_t cuda_stream)
{
	return decode1launch<Scalar>(
      dim, stride, stream, d_data, maxbits, cuda_stream);
}
...
{
	return decode1launch<Scalar>(
      dim, stride, stream, d_data, maxbits, 0);
}
