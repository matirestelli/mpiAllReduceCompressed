...
#SBATCH -p batch
#SBATCH -q extended
#SBATCH -J ddp-train-frontier_rccl_32gpus_8b_32b_128b
#SBATCH -N 4
...
#SBATCH -t 02:00:00
#SBATCH -C nvme
#SBATCH -o ddp_train_frontier_rccl_32gpus_8b_32b_128b.%j.out
#SBATCH -e ddp_train_frontier_rccl_32gpus_8b_32b_128b.%j.err
